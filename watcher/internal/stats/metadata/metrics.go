...
type RecordDoubleDataPointFunc func(*MetricsBuilder, time.Time, float64)
type RecordIntDataPointFunc func(*MetricsBuilder, time.Time, int64)
type RecordIntDataPointWithDirectionFunc func(*MetricsBuilder, time.Time, int64, string, AttributeDirection)
