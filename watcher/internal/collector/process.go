...
// func (a *Collector) processPod(d events.ResourceMessage) {
...
// func (a *Collector) processSvc(d events.ResourceMessage) {
...
// 			Protocol string "json:\"protocol\""
// 		}{
// 			Name:     port.Name, // https://events.io/docs/concepts/services-networking/service/#field-spec-ports
// 			Src:      port.Port,
...
// func (a *Collector) processReplicaSet(d events.ResourceMessage) {
...
// func (a *Collector) processDeployment(d events.ResourceMessage) {
...
// func (a *Collector) processContainer(d events.ResourceMessage) {
// 	c := d.Object.(*events.Container)
...
// func (a *Collector) processEndpoints(ep events.ResourceMessage) {
...
// func (a *Collector) processDaemonSet(d events.ResourceMessage) {
...
// func (a *Collector) processStatefulSet(d events.ResourceMessage) {
