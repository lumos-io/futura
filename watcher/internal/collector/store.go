...
func (a *Collector) persistPod(dto datastore.Pod, eventType string) {
...
func (a *Collector) persistSvc(dto datastore.Service, eventType string) {
...
func (a *Collector) persistReplicaSet(dto datastore.ReplicaSet, eventType string) {
